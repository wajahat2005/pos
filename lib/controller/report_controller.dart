...
class ReportController {
  ...
  final reportAll = futureSignal(() async => Database().getReportAll());
  ...
  final reportOutOfStcok = futureSignal(() async => Database().getLowStock(threshold: 5));
  ...
  final pendingPrintsCount = futureSignal(() async => Database().getPendingPrintsCount());
}
