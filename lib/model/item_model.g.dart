...
void _itemModelSerialize(
  ...
  writer.writeLong(offsets[9], object.jumlahBarang);
  writer.writeLong(offsets[10], object.lowStockLimit);
...
ItemModel _itemModelDeserialize(
  ...
  final object = ItemModel(
    ...
    hargaDasar: reader.readLong(offsets[5]),
    hargaJual: reader.readLong(offsets[6]),
    id: id,
    imagePath: reader.readStringOrNull(offsets[7]),
    isSynced: reader.readBoolOrNull(offsets[8]) ?? true,
    jumlahBarang: reader.readLong(offsets[9]),
    lowStockLimit: reader.readLongOrNull(offsets[10]),
    nama: reader.readString(offsets[11]),
...
extension ItemModelQueryFilter
  ...
  QueryBuilder<ItemModel, ItemModel, QAfterFilterCondition> imagePathIsNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(const FilterCondition.isNull(
  ...
  QueryBuilder<ItemModel, ItemModel, QAfterFilterCondition> imagePathEqualTo(
    String? value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<ItemModel, ItemModel, QAfterFilterCondition> imagePathLessThan(
    String? value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<ItemModel, ItemModel, QAfterFilterCondition> imagePathBetween(
    String? lower,
    String? upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<ItemModel, ItemModel, QAfterFilterCondition> imagePathStartsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<ItemModel, ItemModel, QAfterFilterCondition> imagePathEndsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<ItemModel, ItemModel, QAfterFilterCondition> imagePathContains(
      String value,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.contains(
  ...
  QueryBuilder<ItemModel, ItemModel, QAfterFilterCondition> imagePathMatches(
      String pattern,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.matches(
  ...
  QueryBuilder<ItemModel, ItemModel, QAfterFilterCondition> imagePathIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'imagePath',
        value: '',
...
extension ItemModelQuerySortBy on QueryBuilder<ItemModel, ItemModel, QSortBy> {
  ...
  QueryBuilder<ItemModel, ItemModel, QAfterSortBy> sortByImagePath() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'imagePath', Sort.asc);
    });
  }

  QueryBuilder<ItemModel, ItemModel, QAfterSortBy> sortByImagePathDesc() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<ItemModel, ItemModel, QAfterSortBy> sortByLowStockLimit() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'lowStockLimit', Sort.asc);
    });
  }

  QueryBuilder<ItemModel, ItemModel, QAfterSortBy> sortByLowStockLimitDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension ItemModelQuerySortThenBy
  ...
  QueryBuilder<ItemModel, ItemModel, QAfterSortBy> thenByImagePath() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'imagePath', Sort.asc);
    });
  }

  QueryBuilder<ItemModel, ItemModel, QAfterSortBy> thenByImagePathDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'imagePath', Sort.desc);
    });
  }
  ...
  QueryBuilder<ItemModel, ItemModel, QAfterSortBy> thenByLowStockLimit() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'lowStockLimit', Sort.asc);
    });
  }

  QueryBuilder<ItemModel, ItemModel, QAfterSortBy> thenByLowStockLimitDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'lowStockLimit', Sort.desc);
    });
  }
...
extension ItemModelQueryWhereDistinct
  ...
  QueryBuilder<ItemModel, ItemModel, QDistinct> distinctByImagePath(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<ItemModel, ItemModel, QDistinct> distinctByLowStockLimit() {
    return QueryBuilder.apply(this, (query) {
...
extension ItemModelQueryProperty
  ...
  QueryBuilder<ItemModel, String?, QQueryOperations> imagePathProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<ItemModel, int?, QQueryOperations> lowStockLimitProperty() {
    return QueryBuilder.apply(this, (query) {
