          ...
          children: [
            ...
            Wrap(
              ...
              children: [
                ...
                ShadCard(
                  ...
                  description: Text(
                      'You have ${reportOutOfStcok.value?.length} items with low stock.'),
                  child: Column(
                    children: [
            ...
            ShadCard(
              title: Row(
                ...
                children: [
                  Text(showProfitChart ? 'Report Net Profit by Day' : 'Report Revenue by Day'),
                  Row(
                    children: [
                      const Text('Show Profit: ', style: TextStyle(fontSize: 12)),
                      Switch(
                        value: showProfitChart,
                        onChanged: (val) {
                          setState(() {
                            showProfitChart = val;
                          });
              ...
              child: Padding(
                ...
                child: ReportRevenue(showProfit: showProfitChart),
              ),
            ),
            const SizedBox(height: 20),
                ...
                child: Column(
                  children: [
                    TextFormField(
                      ...
                      onChanged: (val) {
                        setState(() {
                          searchTransactionQuery = val;
                        });
                      },
                    ),
                    const SizedBox(height: 16),
                    ShadAccordion<PenjualanModel>.multiple(
                      children: (report.value ?? [])
                          .where((item) => searchTransactionQuery.isEmpty || item.id.toString().contains(searchTransactionQuery))
                          .toList()
                          .reversed
                          .map(
                                  ...
                                  ...detail.items.map(
                                    (val) => ListTile(
                                      ...
                                      subtitle: Row(
                                        children: [
                                          Text('${val.quantity} x '),
                                          Text(currency.format(val.hargaJual)),
                                        ],
                                      ),
                                      trailing: Text(
